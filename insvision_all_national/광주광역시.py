...
'''앞 8개 그래프 : 매매가격지수 그래프'''
filtered_data1 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['전국', '광주'])]
filtered_data2 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['6대광역시', '광주'])]
'''뒤 8개 그래프 : 전세가격지수 그래프'''
filtered_data5 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['전국', '광주'])]
filtered_data6 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['6대광역시', '광주'])]

'''바그래프'''
filtered_data9 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(
    ['동구','서구','남구','북구','광산구'])]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '동구') & (filtered_data9['CLS_ID'] != 50160))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '서구') & (filtered_data9['CLS_ID'] != 50161))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '남구') & (filtered_data9['CLS_ID'] != 50162))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '북구') & (filtered_data9['CLS_ID'] != 50163))]

filtered_data10 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(
    ['동구','서구','남구','북구','광산구'])]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '동구') & (filtered_data10['CLS_ID'] != 50160))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '서구') & (filtered_data10['CLS_ID'] != 50161))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '남구') & (filtered_data10['CLS_ID'] != 50162))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '북구') & (filtered_data10['CLS_ID'] != 50163))]
...
fig1.update_layout(
    title={
        'text': '매매가격지수 최근 26주 광주광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig2.update_layout(
    title={
        'text': '매매가격지수 최근 26주 광주광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig3.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 광주광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''4번그래프 : 아파트 매매가격지수 등락률 광주광역시 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig4.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 광주광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig9.update_layout(
    title={
        'text': '전세가격지수 최근 26주 광주광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig10.update_layout(
    title={
        'text': '전세가격지수 최근 26주 광주광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig11.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 광주광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''12번그래프 : 전세가격지수 등락률 광주광역시 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig12.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 광주광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''17번그래프 : 광주광역시 전체 구 최근 주차 매매가격지수'''
# 최신 주차 데이터 필터링
...
# 광주광역시 구별 매매가격지수 바 차트 생성
fig17 = px.bar(latest_data,
               x='CLS_NM',  # 구 이름
               y='DTA_VAL',  # 매매가격지수
               color='CLS_NM',  # 구에 따른 색상 구분
               title=f"광주광역시 구별 최근 주차 매매가격지수 ({latest_week})",  # 그래프 제목
               )
...
'''18번그래프 : 광주광역시 전체 구 최근 주차 전세가격지수'''
# 최신 주차 데이터 필터링
...
fig18 = px.bar(latest_data2,
               ...
               y='DTA_VAL',  # 매매가격지수
               color='CLS_NM',  # 구에 따른 색상 구분
               title=f"광주광역시 구별 최근 주차 전세가격지수 ({latest_week2})",  # 그래프 제목
               )
