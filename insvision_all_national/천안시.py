...
fig2.update_layout(
    title={
        'text': '매매가격지수 최근 26주 천안시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig3.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 천안시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''4번그래프 : 아파트 매매가격지수 등락률 천안시 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig4.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 천안시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig5.update_layout(
    title={
        'text': '매매가격지수 최근 26주 천안시 지역구별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''6번그래프 : 매매가격지수 천안시 지역구별 6대광역시 비교'''
...
fig6.update_layout(
    title={
        'text': '매매가격지수 최근 26주 천안시 지역구별 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''7번그래프 : 매매가격지수 등락률 천안시 지역구별 전국 비교'''
# 전월 대비 등락률 계산
...
fig7.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 천안시 지역구별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''8번그래프 : 매매가격지수 등락률 천안시 지역구별 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig10.update_layout(
    title={
        'text': '전세가격지수 최근 26주 천안시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig11.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 천안시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''12번그래프 : 전세가격지수 등락률 천안시 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig12.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 천안시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig13.update_layout(
    title={
        'text': '전세가격지수 최근 26주 천안시 지역구별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''14번그래프 : 전세가격지수 천안시 지역구별 6대광역시 비교'''
...
fig14.update_layout(
    title={
        'text': '전세가격지수 최근 26주 천안시 지역구별 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''15번그래프 : 전세가격지수 등락률 천안시 지역구별 전국 비교'''
# 전월 대비 등락률 계산
...
fig15.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 천안시 지역구별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''16번그래프 : 전세가격지수 등락률 천안시 지역구별 6대광역시 비교'''
# 전월 대비 등락률 계산
