...
'''앞 8개 그래프 : 매매가격지수 그래프'''
filtered_data1 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['전국', '인천'])]
filtered_data2 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['6대광역시', '인천'])]
'''뒤 8개 그래프 : 전세가격지수 그래프'''
filtered_data5 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['전국', '인천'])]
filtered_data6 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['6대광역시', '인천'])]

'''바그래프'''
filtered_data9 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(
    ['중구','동구','연수구','남동구','부평구','계양구','서구'])]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '중구') & (filtered_data9['CLS_ID'] != 50125))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '동구') & (filtered_data9['CLS_ID'] != 50126))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '서구') & (filtered_data9['CLS_ID'] != 50131))]

filtered_data10 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(
    ['중구','동구','연수구','남동구','부평구','계양구','서구'])]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '중구') & (filtered_data10['CLS_ID'] != 50125))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '동구') & (filtered_data10['CLS_ID'] != 50126))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '서구') & (filtered_data10['CLS_ID'] != 50131))]
...
fig1.update_layout(
    title={
        'text': '매매가격지수 최근 26주 인천광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig2.update_layout(
    title={
        'text': '매매가격지수 최근 26주 인천광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig3.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 인천광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''4번그래프 : 아파트 매매가격지수 등락률 인천 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig4.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 인천광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig9.update_layout(
    title={
        'text': '전세가격지수 최근 26주 인천광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig10.update_layout(
    title={
        'text': '전세가격지수 최근 26주 인천광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig11.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 인천광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig12.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 인천광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
# 인천시 구별 매매가격지수 바 차트 생성
fig17 = px.bar(latest_data,
               x='CLS_NM',  # 구 이름
               y='DTA_VAL',  # 매매가격지수
               color='CLS_NM',  # 구에 따른 색상 구분
               title=f"인천광역시 구별 최근 주차 매매가격지수 ({latest_week})",  # 그래프 제목
               )
...
fig18 = px.bar(latest_data2,
               ...
               y='DTA_VAL',  # 매매가격지수
               color='CLS_NM',  # 구에 따른 색상 구분
               title=f"인천광역시 구별 최근 주차 전세가격지수 ({latest_week2})",  # 그래프 제목
               )
