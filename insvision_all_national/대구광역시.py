...
'''앞 8개 그래프 : 매매가격지수 그래프'''
filtered_data1 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['전국', '대구'])]
filtered_data2 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['6대광역시', '대구'])]
'''뒤 8개 그래프 : 전세가격지수 그래프'''
filtered_data5 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['전국', '대구'])]
filtered_data6 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['6대광역시', '대구'])]

'''바그래프'''
filtered_data9 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(
    ['중구','동구','서구','남구','북구','수성구','달서구'])]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '중구') & (filtered_data9['CLS_ID'] != 50151))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '동구') & (filtered_data9['CLS_ID'] != 50152))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '서구') & (filtered_data9['CLS_ID'] != 50153))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '남구') & (filtered_data9['CLS_ID'] != 50154))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '북구') & (filtered_data9['CLS_ID'] != 50155))]
filtered_data10 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(
    ['중구','동구','서구','남구','북구','수성구','달서구'])]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '중구') & (filtered_data10['CLS_ID'] != 50151))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '동구') & (filtered_data10['CLS_ID'] != 50152))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '서구') & (filtered_data10['CLS_ID'] != 50153))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '남구') & (filtered_data10['CLS_ID'] != 50154))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '북구') & (filtered_data10['CLS_ID'] != 50155))]
...
fig1.update_layout(
    title={
        'text': '매매가격지수 최근 26주 대구광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig2.update_layout(
    title={
        'text': '매매가격지수 최근 26주 대구광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig3.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 대구광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''4번그래프 : 아파트 매매가격지수 등락률 대구 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig4.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 대구광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig9.update_layout(
    title={
        'text': '전세가격지수 최근 26주 대구광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig10.update_layout(
    title={
        'text': '전세가격지수 최근 26주 대구광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig11.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 대구광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig12.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 대구광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
# 대구시 구별 매매가격지수 바 차트 생성
fig17 = px.bar(latest_data,
               x='CLS_NM',  # 구 이름
               y='DTA_VAL',  # 매매가격지수
               color='CLS_NM',  # 구에 따른 색상 구분
               title=f"대구광역시 구별 최근 주차 매매가격지수 ({latest_week})",  # 그래프 제목
               )
...
fig17.update_layout(
    ...
    yaxis=dict(
        ...
        showgrid=True,  # 가로선 표시
        gridwidth=1,
        range=[60, y_max9 + 5],  # y축의 최솟값과 최댓값에 마진 추가
...
fig18 = px.bar(latest_data2,
               ...
               y='DTA_VAL',  # 매매가격지수
               color='CLS_NM',  # 구에 따른 색상 구분
               title=f"대구광역시 구별 최근 주차 전세가격지수 ({latest_week2})",  # 그래프 제목
               )
...
fig18.update_layout(
    ...
    yaxis=dict(
        ...
        showgrid=True,  # 가로선 표시
        gridwidth=1,
        range=[60, y_max10 + 5],  # y축의 최솟값과 최댓값에 마진 추가
        gridcolor='rgba(211, 211, 211, 0.5)'  # 연한 회색 가로선
    ),
    bargap=0.3,  # 바 간의 간격 (0~1 사이 값)
    plot_bgcolor='white',  # 그래프 배경색
