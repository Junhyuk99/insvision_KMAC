...
!구1이름을넣어주세요, !구2이름을넣어주세요, !구3이름을넣어주세요 에 해당 시의 구들을 넣어주면 됩니다. 정확한 구의 이름은 데이터파일의 CLS_NM 열에서 확인이 가능합니다.
만약 구가 2개라면 2개만 넣어주시고 !구3이름을넣어주세요 가 있는 문자열은 삭제하셔도 됩니다.'''
...
'''앞 8개 그래프 : 매매가격지수 그래프'''
filtered_data1 = goyang_weekly_tx[goyang_weekly_tx['CLS_NM'].isin(['전국', '!시/도이름을넣어주세요'])]
filtered_data2 = goyang_weekly_tx[goyang_weekly_tx['CLS_NM'].isin(['6대광역시', '!시/도이름을넣어주세요'])]
filtered_data3 = goyang_weekly_tx[goyang_weekly_tx['CLS_NM'].isin(['전국', '!구1이름을넣어주세요', '!구2이름을넣어주세요', '!구3이름을넣어주세요'])]
filtered_data4 = goyang_weekly_tx[goyang_weekly_tx['CLS_NM'].isin(['6대광역시', '!구1이름을넣어주세요', '!구2이름을넣어주세요', '!구3이름을넣어주세요'])]
'''뒤 8개 그래프 : 전세가격지수 그래프'''
filtered_data5 = goyang_weekly_res[goyang_weekly_res['CLS_NM'].isin(['전국', '!시/도이름을넣어주세요'])]
filtered_data6 = goyang_weekly_res[goyang_weekly_res['CLS_NM'].isin(['6대광역시', '!시/도이름을넣어주세요'])]
filtered_data7 = goyang_weekly_res[goyang_weekly_res['CLS_NM'].isin(['전국', '!구1이름을넣어주세요', '!구2이름을넣어주세요', '!구3이름을넣어주세요'])]
filtered_data8 = goyang_weekly_res[goyang_weekly_res['CLS_NM'].isin(['6대광역시', '!구1이름을넣어주세요', '!구2이름을넣어주세요', '!구3이름을넣어주세요'])]
...
'''1번그래프 : 매매가격지수 !시/도이름을넣어주세요 전국 비교'''
...
fig1.update_layout(
    title={
        'text': '매매가격지수 최근 26주 !시/도이름을넣어주세요 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''2번그래프 : 매매가격지수 !시/도이름을넣어주세요 6대광역시 비교'''
# y축 최솟값과 최댓값 계산
...
fig2.update_layout(
    title={
        'text': '매매가격지수 최근 26주 !시/도이름을넣어주세요 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''3번그래프 : 매매가격지수 등락률 !시/도이름을넣어주세요 전국 비교'''
# 전월 대비 등락률 계산
...
fig3.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 !시/도이름을넣어주세요 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''4번그래프 : 아파트 매매가격지수 등락률 !시/도이름을넣어주세요 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig4.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 !시/도이름을넣어주세요 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''5번그래프 : 매매가격지수 !시/도이름을넣어주세요 지역구별 전국 비교'''
...
fig5.update_layout(
    title={
        'text': '매매가격지수 최근 26주 !시/도이름을넣어주세요 지역구별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''6번그래프 : 매매가격지수 !시/도이름을넣어주세요 지역구별 6대광역시 비교'''
...
fig6.update_layout(
    title={
        'text': '매매가격지수 최근 26주 !시/도이름을넣어주세요 지역구별 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''7번그래프 : 매매가격지수 등락률 !시/도이름을넣어주세요 지역구별 전국 비교'''
# 전월 대비 등락률 계산
...
fig7.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 !시/도이름을넣어주세요 지역구별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''8번그래프 : 매매가격지수 등락률 !시/도이름을넣어주세요 지역구별 6대광역시 비교'''
# 전월 대비 등락률 계산
...
'''9번그래프 : 전세가격지수 !시/도이름을넣어주세요 전국 비교'''
...
fig9.update_layout(
    title={
        'text': '전세가격지수 최근 26주 !시/도이름을넣어주세요 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''10번그래프 : 전세가격지수 !시/도이름을넣어주세요 6대광역시 비교'''
# y축 최솟값과 최댓값 계산
...
fig10.update_layout(
    title={
        'text': '전세가격지수 최근 26주 !시/도이름을넣어주세요 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''11번그래프 : 전세가격지수 등락률 !시/도이름을넣어주세요 전국 비교'''
# 전월 대비 등락률 계산
...
fig11.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 !시/도이름을넣어주세요 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''12번그래프 : 전세가격지수 등락률 !시/도이름을넣어주세요 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig12.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 !시/도이름을넣어주세요 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''13번그래프 : 전세가격지수 !시/도이름을넣어주세요 지역구별 전국 비교'''
...
fig13.update_layout(
    title={
        'text': '전세가격지수 최근 26주 !시/도이름을넣어주세요 지역구별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''14번그래프 : 전세가격지수 !시/도이름을넣어주세요 지역구별 6대광역시 비교'''
...
fig14.update_layout(
    title={
        'text': '전세가격지수 최근 26주 !시/도이름을넣어주세요 지역구별 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''15번그래프 : 전세가격지수 등락률 !시/도이름을넣어주세요 지역구별 전국 비교'''
# 전월 대비 등락률 계산
...
fig15.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 !시/도이름을넣어주세요 지역구별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''16번그래프 : 전세가격지수 등락률 !시/도이름을넣어주세요 지역구별 6대광역시 비교'''
# 전월 대비 등락률 계산
