...
'''앞 8개 그래프 : 매매가격지수 그래프'''
filtered_data1 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['전국', '부산'])]
filtered_data2 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['6대광역시', '부산'])]
filtered_data3 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['전국', '중부산권', '동부산권', '서부산권'])]
filtered_data4 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(['6대광역시', '중부산권', '동부산권', '서부산권'])]
'''뒤 8개 그래프 : 전세가격지수 그래프'''
filtered_data5 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['전국', '부산'])]
filtered_data6 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['6대광역시', '부산'])]
filtered_data7 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['전국', '중부산권', '동부산권', '서부산권'])]
filtered_data8 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(['6대광역시', '중부산권', '동부산권', '서부산권'])]

'''바그래프'''
filtered_data9 = seoul_weekly_tx[seoul_weekly_tx['CLS_NM'].isin(
    ['중구', '서구', '동구', '영도구', '부산진구', '동래구', '남구', '북구', '강서구', '해운대구', '사하구', '금정구', '연제구', '수영구', '사상구'])]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '중구') & (filtered_data9['CLS_ID'] != 50132))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '서구') & (filtered_data9['CLS_ID'] != 50133))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '동구') & (filtered_data9['CLS_ID'] != 50134))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '남구') & (filtered_data9['CLS_ID'] != 50136))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '강서구') & (filtered_data9['CLS_ID'] != 50148))]
filtered_data9 = filtered_data9[~((filtered_data9['CLS_NM'] == '북구') & (filtered_data9['CLS_ID'] != 50146))]
filtered_data10 = seoul_weekly_res[seoul_weekly_res['CLS_NM'].isin(
    ['중구', '서구', '동구', '영도구', '부산진구', '동래구', '남구', '북구', '강서구', '해운대구', '사하구', '금정구', '연제구', '수영구', '사상구'])]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '중구') & (filtered_data10['CLS_ID'] != 50132))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '서구') & (filtered_data10['CLS_ID'] != 50133))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '동구') & (filtered_data10['CLS_ID'] != 50134))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '남구') & (filtered_data10['CLS_ID'] != 50136))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '강서구') & (filtered_data10['CLS_ID'] != 50148))]
filtered_data10 = filtered_data10[~((filtered_data10['CLS_NM'] == '북구') & (filtered_data10['CLS_ID'] != 50146))]
...
fig1.update_layout(
    title={
        'text': '매매가격지수 최근 26주 부산광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig2.update_layout(
    title={
        'text': '매매가격지수 최근 26주 부산광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig3.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 부산광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''4번그래프 : 아파트 매매가격지수 등락률 부산 6대광역시 비교'''
# 전월 대비 등락률 계산
...
fig4.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 부산광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig5.update_layout(
    title={
        'text': '매매가격지수 최근 26주 부산광역시 권역별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig6.update_layout(
    title={
        'text': '매매가격지수 최근 26주 부산광역시 권역별 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
y_min_with_margin3_change = y_min3_change - 0.1
y_max3_change = filtered_data3_change['change_rate'].max()
y_max_with_margin3_change = y_max3_change + 0.1
...
fig7.update_layout(
    title={
        'text': '매매가격지수 등락률 최근 26주 부산광역시 권역별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''8번그래프 : 매매가격지수 등락률 부산 권역별 6대광역시 비교'''
# 전월 대비 등락률 계산
...
y_min_with_margin4_change = y_min4_change - 0.1
y_max4_change = filtered_data4_change['change_rate'].max()
y_max_with_margin4_change = y_max4_change + 0.1
...
fig9.update_layout(
    title={
        'text': '전세가격지수 최근 26주 부산광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig10.update_layout(
    title={
        'text': '전세가격지수 최근 26주 부산광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig11.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 부산광역시 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig12.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 부산광역시 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig13.update_layout(
    title={
        'text': '전세가격지수 최근 26주 부산광역시 권역별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig14.update_layout(
    title={
        'text': '전세가격지수 최근 26주 부산광역시 권역별 6대광역시 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''15번그래프 : 전세가격지수 등락률 부산 권역별 전국 비교'''
# 전월 대비 등락률 계산
...
y_min_with_margin7_change = y_min7_change - 0.1
y_max7_change = filtered_data7_change['change_rate'].max()
y_max_with_margin7_change = y_max7_change + 0.1
...
fig15.update_layout(
    title={
        'text': '전세가격지수 등락률 최근 26주 부산광역시 권역별 전국 비교',
        'y': 0.95,
        'x': 0.5,
        'xanchor': 'center',
        'yanchor': 'top',
...
'''16번그래프 : 전세가격지수 등락률 부산 권역별 6대광역시 비교'''
# 전월 대비 등락률 계산
...
y_min_with_margin8_change = y_min8_change - 0.1
y_max8_change = filtered_data8_change['change_rate'].max()
y_max_with_margin8_change = y_max8_change + 0.1
...
# 부산시 구별 매매가격지수 바 차트 생성
fig17 = px.bar(latest_data,
               x='CLS_NM',  # 구 이름
               y='DTA_VAL',  # 매매가격지수
               color='CLS_NM',  # 구에 따른 색상 구분
               title=f"부산광역시 구별 최근 주차 매매가격지수 ({latest_week})",  # 그래프 제목
               )
...
fig18 = px.bar(latest_data2,
               ...
               y='DTA_VAL',  # 전세가격지수
               color='CLS_NM',  # 구에 따른 색상 구분
               title=f"부산광역시 구별 최근 주차 전세가격지수 ({latest_week2})",  # 그래프 제목
               )
