...
'''앞 8개 그래프 : 매매가격지수 그래프'''
filtered_data1 = goyang_weekly_tx[goyang_weekly_tx['CLS_NM'].isin(['전국', '고양시'])]
filtered_data2 = goyang_weekly_tx[goyang_weekly_tx['CLS_NM'].isin(['6대광역시', '고양시'])]
filtered_data3 = goyang_weekly_tx[goyang_weekly_tx['CLS_NM'].isin(['전국', '덕양구', '일산동구', '일산서구'])]
filtered_data4 = goyang_weekly_tx[goyang_weekly_tx['CLS_NM'].isin(['6대광역시', '덕양구', '일산동구', '일산서구'])]
'''뒤 8개 그래프 : 전세가격지수 그래프'''
filtered_data5 = goyang_weekly_res[goyang_weekly_res['CLS_NM'].isin(['전국', '고양시'])]
filtered_data6 = goyang_weekly_res[goyang_weekly_res['CLS_NM'].isin(['6대광역시', '고양시'])]
filtered_data7 = goyang_weekly_res[goyang_weekly_res['CLS_NM'].isin(['전국', '덕양구', '일산동구', '일산서구'])]
filtered_data8 = goyang_weekly_res[goyang_weekly_res['CLS_NM'].isin(['6대광역시', '덕양구', '일산동구', '일산서구'])]
